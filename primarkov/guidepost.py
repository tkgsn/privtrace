...
#         print(noisy_matrix)
        self.order2_trans_matrix = noisy_matrix.astype(float)
#         print(self.order2_trans_matrix)
    ...
    def multiply_ends(self, multiplier):
        # print("multiply_ends", multiplier)
        # print(self.order2_trans_matrix[:, -1])
        # print(self.order2_trans_matrix[:, -1] * multiplier)
